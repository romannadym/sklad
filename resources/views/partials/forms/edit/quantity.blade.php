...
<div class="form-group {{ $errors->has('qty') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7">
       <div class="col-md-3" style="padding-left:0px">
           <input class="form-control" maxlength="5" type="text" name="qty" aria-label="qty" id="qty" value="{{ old('qty', $item->qty) ? old('qty', $item->qty) : '1' }}" {!!  (Helper::checkIfRequired($item, 'qty')) ? ' required ' : '' !!}/>
       </div>
