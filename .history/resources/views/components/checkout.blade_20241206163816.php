      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <!-- Asset -->
            ...
            @include ('partials.forms.edit.user-select', ['translated_name' => trans('general.user_asset'), 'fieldname' => 'assigned_to_user_id', 'label' => trans('admin/components/general.user_asset')])
