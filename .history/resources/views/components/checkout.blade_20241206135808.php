      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <!-- Asset -->
            ...
            <div class="form-group {{ $errors->has('ticketnum') ? ' has-error' : '' }}">
              <label for="ticketnum" class="col-md-3 control-label">
                {{ trans('general.ticketnum') }}
              </label>
              <div class="col-md-2 col-sm-5 col-xs-5">
                <input class="form-control required col-md-12" type="text" name="ticketnum" id="ticketnum" value="{{ old('ticketnum') ?? 1 }}"/>
              </div>
