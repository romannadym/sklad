          ...
          <div class="table table-responsive">
            ...
            <table
              ...
              <tr>
                ...
                <th data-searchable="false" data-sortable="false" data-field="name" data-formatter="usersLinkObjFormatter">
                  {{ trans('Инженер') }}
                </th>
...
$(document).ready(function () {
    $('#componentsCheckedoutTable').bootstrapTable({
        ajaxOptions: {
            complete: function (xhr) {
                console.log('Raw API response:', xhr.responseJSON);
            }
        }
    });

    $('#componentsCheckedoutTable').on('load-success.bs.table', function (e, data) {
