...
class Component extends SnipeModel
{
    ...
    {
        return $this->belongsToMany(\App\Models\Asset::class, 'components_assets')->withPivot('id', 'assigned_qty', 'created_at', 'created_by', 'note','ticketnum','assigned_to_user_id')->withTimestamps();
    }
    public function assignedUsers()
    {
        return $this->belongsToMany(\App\Models\User::class, 'components_assets', 'component_id', 'assigned_to_user_id')
                    ->withPivot('id', 'assigned_qty', 'note', 'ticketnum', 'created_at', 'created_by') // Указываем дополнительные поля
