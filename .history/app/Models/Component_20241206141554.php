...
class Component extends SnipeModel
{
     ...
     * @var array
     */
    protected $searchableAttributes = ['name', 'order_number', 'serial', 'partnum', 'status', 'customer', 'purchase_cost', 'purchase_date', 'notes','ticketnum'];
    ...
    {
        return $this->belongsToMany(\App\Models\Asset::class, 'components_assets')->withPivot('id', 'assigned_qty', 'created_at', 'created_by', 'note','ticketnum');
    }
